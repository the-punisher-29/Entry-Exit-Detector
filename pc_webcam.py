...
def parse_arguments():
    ...
    ap.add_argument("-p", "--prototxt", required=False, default="E:\Pr\ML\People-Counting-in-Real-Time\detector\MobileNetSSD_deploy.prototxt",
                    help="path to Caffe 'deploy' prototxt file")
    ap.add_argument("-m", "--model", required=False, default="E:\Pr\ML\People-Counting-in-Real-Time\detector\MobileNetSSD_deploy.caffemodel",
...
def people_counter():
    ...
    if not args.get("input", False):
        ...
        vs = VideoStream(src=0).start()  # Using default webcam
        time.sleep(2.0)
